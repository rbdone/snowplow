...
-- Move over the remaining data to the snowplow_intermediary.sessions_in_progress table.
-- The standard model identifies sessions using only first party cookies and session domain indexes.

BEGIN;
	DROP TABLE IF EXISTS snowplow_intermediary.sessions_in_progress;
	CREATE TABLE snowplow_intermediary.sessions_in_progress
